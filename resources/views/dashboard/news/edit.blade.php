                ...
                <div class="row">
                    <div class="col">
                        <div class="mb-3">
                            ...
                            <input type="text" name="title"
                                ...
                                aria-describedby="title" value="{{ $news->title }}">
                            @error('title')
                    ...
                    <div class="col">
                        <div class="mb-3">
                            ...
                            <img id="blah" src="{{ asset('storage/' . $news->cover_image) }}" alt=""  class="mt-3" style="max-height: 200px; max-width: 300px;"/>
                            @error('cover_image')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
